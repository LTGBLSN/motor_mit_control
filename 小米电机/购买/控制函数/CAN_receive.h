...
typedef enum
{
    LEFT_MOTOR_RECV = 0x142,
    RIGHT_MOTOR_RECV = 0x141,
...
extern void joint_motor_save_pos();
extern void leg_goto_zero_position();
extern void joint_motor_enable();
extern void stop_joint_motor();
